    ...
    public partial class ServerUnitModelGridListScriptsUser
{
    ...
    /// </summary>
    public ServerUnitModelGridListScriptsUser(ServerUnitModelGridListControls TipoDeEmpleadoGridListControles, IJSRuntime js)
    {
...
#region Atributos (modelos y controles)
    ...
    /// </summary>
    public ServerUnitModelGridListControls TipoDeEmpleadoGridListControles { get; set; }
