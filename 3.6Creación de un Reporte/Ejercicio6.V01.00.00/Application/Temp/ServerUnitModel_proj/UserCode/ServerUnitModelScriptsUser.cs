...
#region DeletedBy
    ...
    public ServerUnitModelScriptsUser(IJSRuntime JS, ServerUnitModelControls TipoDeEmpleadoControles)
    {
    ...
    public ServerUnitModelControls TipoDeEmpleadoControles { get; set; }
}
}
