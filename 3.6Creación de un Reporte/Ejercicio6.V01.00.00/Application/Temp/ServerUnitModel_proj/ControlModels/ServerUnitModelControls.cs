///------------------------------------------------------------------------------------------------------------------
/// Código autogenerado por la template WoTemplateGenericClass en el path WooW.SB\WooW.SB\BlazorGenerator\BlazorTemplates\CommonTemplates\ControlModels\WoTemplateModelControlsBlazor.tt
...
namespace ServerUnitModel_proj.ControlModels
{
    ...
    public class ServerUnitModelControls
    {
       ...
       /// </summary>
       public ServerUnitModelControls() { }
        ...
        // Este código fue generado por el fichero WoMemoEditView.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoMemoEdit\WoMemoEditView.cs.
        // WoWSB por el generador a día 5-10-2023

        /// <summary>
        /// Instancia de la vista del input de texto Usuario.
        /// </summary>
        public WoEditView Descripcion { get; set; } = new WoEditView();

        /// <summary>
        /// Instancia de la vista del input de texto Usuario.
        /// </summary>
        public WoFormItemView DescripcionContainer { get; set; } = new WoFormItemView();

        /// <summary>
        /// Instancia de la vista del input de texto Usuario.
        /// </summary>
        public WoInputAlertView DescripcionAlert { get; set; } = new WoInputAlertView();
        #endregion Descripcion

        #region TieneBeneficios

        // Este código fue generado por el fichero WoCheckBoxEditView.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoCheckBoxEdit\WoCheckBoxEditView.cs.
        // WoWSB por el generador a día 5-10-2023

        /// <summary>
        /// Instancia de la vista del input de texto Usuario.
        /// </summary>
        public WoEditView TieneBeneficios { get; set; } = new WoEditView();

        /// <summary>
        /// Instancia de la vista del input de texto Usuario.
        /// </summary>
        public WoFormItemView TieneBeneficiosContainer { get; set; } = new WoFormItemView();

        /// <summary>
        /// Instancia de la vista del input de texto Usuario.
        /// </summary>
        public WoInputAlertView TieneBeneficiosAlert { get; set; } = new WoInputAlertView();
