...
namespace ServerUnitModel_proj.Pages
{
    
    public partial class ServerUnitModelLayout
    {
        ...
        /// </summary>
        [Inject]
        public ServerUnitModelControls _modelControls { get; set; }
        ...
        /// </summary>
        [Inject]
        public ServerUnitModelScriptsUser _scriptsUser { get; set; }
        ...
        /// </summary>
        [Inject]
        private ServerUnitModelTransitionSettings _TipoDeEmpleadoTransitionSettings { get; set; }
     ...
     #region Instancias de los scripts de otros formularios
        ...
        /// <summary>
        private ServerUnitModelValidator _authValidator = new ServerUnitModelValidator();
