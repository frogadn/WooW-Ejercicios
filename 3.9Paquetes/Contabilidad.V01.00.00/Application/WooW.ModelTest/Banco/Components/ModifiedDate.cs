...
namespace WooW.ModelTest.Banco.Components
{
    public class ModifiedDate
    {
        ...
        /// <summary>
        /// Instancia del texto de ModifiedDate
        /// </summary>
        private WoDateEdit _dteModifiedDate;
        ...
        public ModifiedDate()
        {
            try
            {
                _dteModifiedDate = new WoDateEdit("dteModifiedDate");
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        private DateTime Get()
        {
            try
            {
                ...
                string value = _dteModifiedDate.GetValue();
        ...
        private void Set(DateTime value)
        {
            try
            {
                ...
                _dteModifiedDate.SetValue(value);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
