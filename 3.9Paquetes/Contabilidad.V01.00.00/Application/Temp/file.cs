...
public class Program
{
    ...
    {
        BancoGridListScriptsUser su = new BancoGridListScriptsUser();
        su.MainMethod();
    }
}
...
public partial class BancoGridListScriptsUser
{
    ...
    public class BancoGridListControls
    {
...
public class WoFormAlertModel
{
    ...
    /// Tipo de alerta.
    /// </summary>
    private eTipoDeAlerta AlertType { get; set; }
...
public class WoDetailGridView
{
    ...
    private void InvokeChangeEditionMode() =>
        ChangeEditionModeEvt?.Invoke(this, _editionModeStatus);
    ...
    private void InvokeChangeHeaderBGColor() =>
        ChangeHeaderBackgroundColorEvt?.Invoke(this, _headerBackgroundColor);
    ...
    private void InvokeChangeRowsBGColor1() =>
        ChangeRowsBackgroundColor1Evt?.Invoke(this, _rowsColor1);
    ...
    private void InvokeChangeRowsBGColor2() =>
        ChangeRowsBackgroundColor2Evt?.Invoke(this, _rowsColor2);
