...
public class EmpleadoModel
{
    ...
    /// <summary>
    /// Instancia del input de la propiedad __TipoDeEmpleadoId
    /// </summary>
    public __TipoDeEmpleadoId __TipoDeEmpleadoId;
    ...
    public EmpleadoModel()
    {
        try
        {
            ...
            // Inicialización del componente __TipoDeEmpleadoId
            __TipoDeEmpleadoId = new __TipoDeEmpleadoId();
