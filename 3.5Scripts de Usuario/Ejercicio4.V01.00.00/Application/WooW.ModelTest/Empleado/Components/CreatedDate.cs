...
namespace WooW.ModelTest.Empleado.Components
{
    public class CreatedDate
    {
        ...
        /// <summary>
        /// Instancia del texto de CreatedDate
        /// </summary>
        private WoDateEdit _dteCreatedDate;
        ...
        public CreatedDate()
        {
            try
            {
                _dteCreatedDate = new WoDateEdit("dteCreatedDate");
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
        ...
        private DateTime Get()
        {
            try
            {
                ...
                string value = _dteCreatedDate.GetValue();
        ...
        private void Set(DateTime value)
        {
            try
            {
                ...
                _dteCreatedDate.SetValue(value);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.Message);
