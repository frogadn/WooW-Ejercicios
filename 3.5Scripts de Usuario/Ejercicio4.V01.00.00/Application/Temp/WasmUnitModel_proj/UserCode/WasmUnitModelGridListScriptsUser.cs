    ...
    public partial class WasmUnitModelGridListScriptsUser
{
    ...
    /// </summary>
    public WasmUnitModelGridListScriptsUser(WasmUnitModelGridListControls EmpleadoGridListControles, IJSRuntime js)
    {
...
#region Atributos (modelos y controles)
    ...
    /// </summary>
    public WasmUnitModelGridListControls EmpleadoGridListControles { get; set; }
