...
{
    public class WoMenusReqServiceInterface : Service
    {
        public IList<WoMenusRes> Get(WoMenusReq GetRequest)
        {
            return WoMenusReq.Get(new WoTargetConnection(Request, Db), GetRequest);
        }
